...
const Hero = () => {
  return (
    <div className='relative flex flex-col-reverse sm:flex-row min-h-[320px] sm:min-h-[380px] border-b border-gray-200 overflow-hidden'>
      <div className='w-full sm:w-1/2 flex items-center justify-center py-12 sm:py-0 px-6 bg-gray-50'>
        <div className='text-gray-800 text-center sm:text-left max-w-md'>
          ...
          <h1 className='font-semibold text-3xl sm:text-4xl lg:text-5xl leading-tight py-4 tracking-tight'>Latest Arrivals</h1>
